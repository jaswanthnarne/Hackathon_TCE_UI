...
const navItems = [
  ...
  { path: '/console/admin/staff', label: 'Staff & Support', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a3 3 0 11-6 0 3 3 0 016 0z' },
  { path: '/console/admin/tables', label: 'Seating Plan', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z' },
  { path: '/console/admin/meals', label: 'Meal Passes', icon: 'M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z' },
  { path: '/console/admin/challenges', label: 'Challenges', icon: 'M11 4a2 2 0 114 0v2a2 2 0 11-4 0V4zm-4 8a2 2 0 114 0v2a2 2 0 11-4 0v-2zm10 0a2 2 0 114 0v2a2 2 0 11-4 0v-2z' },
  { path: '/console/admin/judging', label: 'Judging Scoreboard', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
        ...
        <header className="sticky top-0 z-20 bg-white/95 backdrop-blur-md border-b border-slate-200 px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-sm font-medium text-slate-500 hidden sm:block">Welcome back, <span className="font-bold text-slate-900">{admin?.name || 'Admin'}</span></h2>
            </div>
            <div className="flex items-center gap-3">
